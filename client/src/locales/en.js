export default {
  ...
  restocking: {
    title: 'Restocking',
    description: 'Allocate your budget to restock items based on demand forecasts',
    ...
    noItems: 'No items can be allocated within the current budget',
